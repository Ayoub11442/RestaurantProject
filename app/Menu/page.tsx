...
export default function Home() {
  ...
  {/* Menu */}
<section id="menu" className="min-h-screen bg-[url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-4.0.3')] bg-fixed bg-cover bg-center py-20 px-4 relative">
    {/* Refined overlay with multi-layer gradient */}
    ...
    <div className="relative max-w-7xl mx-auto pt-20">
        ...
        <div className="text-center mb-24 text-white">
            <span className="inline-block text-yellow-400 text-lg font-medium tracking-widest mb-4 px-6 py-2 border border-yellow-400/30 rounded-full animate-pulse">
                CULINARY EXCELLENCE
            </span>
            <h2 className="text-7xl md:text-9xl font-extrabold mb-8 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-yellow-50 to-gray-300 animate-fade-in">
                Our Menu
            </h2>
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed font-light italic">
                "Where every dish tells a story of flavor and passion"
            </p>
        </div>

        {/* Refined Menu Grid with Enhanced Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-4">
            {[
                {
                    name: "Signature Fried Chicken",
                    price: "$15.99",
                    description: "Our legendary crispy chicken, perfectly seasoned with 11 secret herbs and spices",
                    category: "Chef's Special",
                    image: "https://images.unsplash.com/photo-1626645738196-c2a7c87a8f58?ixlib=rb-4.0.3",
                    popular: true,
                    spicyLevel: 2
                },
                {
                    ...
                    price: "$13.99",
                    description: "Sweet and spicy wings glazed with authentic Korean BBQ sauce",
                    category: "Wings",
                ...
                },
                {
                    ...
                    category: "Burgers",
                    image: "https://das-burgerwerk.de/wiehl/wp-content/uploads/2021/08/burger_shoot_24-175.jpg",
                    spicyLevel: 1
                },
                {
                    name: "Grilled Chicken Salad",
                    price: "$11.99",
                    description: "Fresh mixed greens with grilled chicken breast and house dressing",
                    category: "Healthy",
                ...
                },
                {
                    ...
                    price: "$10.99",
                    description: "Spicy buffalo chicken with ranch dressing in a tortilla wrap",
                    category: "Wraps",
                ...
                <div key={item.name} 
                     className="group bg-white/90 backdrop-blur-md p-7 rounded-[2rem] shadow-2xl 
                              hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-3
                              border border-white/20 hover:border-white/40">
                    <div className="overflow-hidden rounded-2xl mb-6 h-72 relative">
                        <img 
                            src={item.image} 
                            alt={item.name}
                        ...
                        {item.popular && (
                            <span className="absolute top-4 right-4 bg-gradient-to-r from-yellow-400 to-orange-400 
                                           text-black px-6 py-2 rounded-full text-sm font-bold shadow-xl
                                           animate-bounce">
                                Bestseller
                            </span>
                        )}
                    ...
                    <p className="text-gray-600 mt-3 min-h-[60px] text-base leading-relaxed">
                        {item.description}
                    </p>
                    <div className="mt-8 flex items-center justify-between">
                        <p className="text-4xl font-black bg-gradient-to-r from-gray-900 to-gray-700 
                                    bg-clip-text text-transparent">{item.price}</p>
                        <button className="px-8 py-3 bg-gradient-to-r from-gray-900 to-gray-700 
                                         text-white rounded-full transform transition-all duration-300 
                                         hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-2 
                                         focus:ring-gray-900 focus:ring-offset-2 font-bold
